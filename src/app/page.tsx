      ...
      >
        ...
        <div className="h-[66px] relative flex flex-col sm:flex-row items-center justify-between w-full sm:h-auto py-4 sm:py-0">
          ...
          <div className="flex items-center gap-2 mb-4 sm:mb-0">
            <FiBarChart2 className="h-6 w-6 sm:h-8 sm:w-8 text-purple-500" />
            <h1 className="text-2xl sm:text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-sky-700">
              Sorting Visualizer
            </h1>
          </div>
